                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      ...
                                      <a href="<?php echo base_url()?>Doktern/hapus_dokter/<?php echo $item->id_dokter ?>" type="button" title="Hapus" onclick="return confirm('Hapus item ini Dari Database ?')" class="btn btn-custon-three btn-danger btn-xs"><i class="fa fa-trash"></i></a>
                                    </td>
                                  </tr>
                                <?php } ?>
                                </tbody>
...
<script type="text/javascript">
  function edit(id_dokter,nama,jekel,lahir,tgl,agama,alamat,kontak,spesialis,no_praktek){
    $('#xid_dokter').val(id_pasien);
    $('#xnama').val(nama);
    $('#xjekel').val(jekel);
    $('#xlahir').val(lahir);
    $('#xtgl').val(tgl);
