                                            ...
                                            <div role="menu" class="author-message-top dropdown-menu animated flipInX">
                                                ...
                                                <ul class="message-menu">
                                                    <li>
                                                        <a href="#">
                                                            <div class="message-img">
                                                                <img src="<?php echo base_url()?>assets/img/message/1.jpg" alt="">
                                                            </div>
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <div class="message-img">
                                                                <img src="<?php echo base_url()?>assets/img/message/4.jpg" alt="">
                                                            </div>
                                                            <div class="message-content">
                                                                <span class="message-date">16 Sept</span>
                                                                <h2>Sulaiman din</h2>
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <div class="message-img">
                                                                <img src="<?php echo base_url()?>assets/img/message/3.jpg" alt="">
                                                            </div>
                                                            <div class="message-content">
                                                                <span class="message-date">16 Sept</span>
                                                                <h2>Victor Jara</h2>
                                                    ...
                                                    <li>
                                                        <a href="#">
                                                            <div class="message-img">
                                                                <img src="<?php echo base_url()?>assets/img/message/2.jpg" alt="">
                                                            </div>
                                                            <div class="message-content">
                                                                <span class="message-date">16 Sept</span>
                                                                <h2>Victor Jara</h2>
