    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="all-form-element-inner">
                <form action="<?php echo base_url()?>Lab/simpan_hasil_proses" method="post">
                  <div class="form-group-inner">
                   <div class="row">
                       ...
                       <div class="col-lg-9">
                           <input name="id_periksa" type="hidden" id="xid_periksa" readonly="true" class="form-control" />
                 ...
                 <div class="form-group-inner">
                  <div class="row">
                      <div class="col-lg-2">
                          <label class="login2 pull-right pull-right-pro">Sub</label>
                      </div>
                      <div class="col-lg-9">
               ...
               <div class="form-group-inner">
                <div class="row">
                    ...
                    <div class="col-lg-9">
                      <input name="nilai_rujukan" type="text" class="form-control" />
                    </div>
                </div>
              </div>
              <div class="form-group-inner">
             ...
             <div class="form-group-inner">
              <div class="row">
                  <div class="col-lg-2">
                      <label class="login2 pull-right pull-right-pro">Dokter</label>
                  </div>
                  <div class="col-lg-9">
