        ...
        <div class="sparkline12-list shadow-reset mg-t-30">
            <div class="sparkline12-hd">
                <div class="main-sparkline12-hd">
                    <h1>Form Tambah Pengguna Baru</h1>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="all-form-element-inner">
                                <form action="<?php echo base_url()?>Users/tambah_pengguna_proses" method="post">
                                  <div class="form-group-inner">
                                   <div class="row">
                                       ...
                                       <div class="col-lg-8">
                                           <input name="nik" type="text" id="xnik" class="form-control" />
                                       </div>
                                       <div class="col-lg-1">
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id=""><i class="fa fa-user"></i> DATA PEGAWAI</h4>
			</div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                        ...
                                        <tbody>
                                          ...
                                          <tr>
                                            ...
                                            <td><i class="btn btn-xs btn-success fa fa-check" title="Pilih" onclick="pilih_item('<?php echo $item->nik ?>','<?php echo $nama_pisah[0] ?>')" data-dismiss="modal"></a></td>
                                          </tr>
                                        <?php } ?>
                                        </tbody>
                                    </table>
...
<script type="text/javascript">
  function pilih_item(nik,nama_pegawai){
    $("#xnik").val(nik);
    $("#xnama").val(nama_pegawai);
  }
</script>
